...
import org.university_student_bff.exceptions.*;
...
public class ExceptionHandlerController {
    ...
    @ExceptionHandler(ConfirmPasswordChangeException.class)
    public ResponseEntity<Void> confirmPasswordChangeExceptionHandler(Exception exception) {

        URI redirectUri = URI.create("http://localhost:8085/passwordChangeUnsuccessful");
    ...
    @ExceptionHandler(RegisterActivationException.class)
    public ResponseEntity<Void> registerActivationExceptionHandler(Exception exception) {

        URI redirectUri = URI.create("http://localhost:8085/registrationUnsuccessful");
